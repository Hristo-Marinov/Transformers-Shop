    ...
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        private void SeedProducts(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 2, Name = "Transformer 2", Picture = "https://media.tenor.com/r06Prd4E5i0AAAAe/transformers-funny.png", Description = "Description for Transformer 2", StockCount = 10, CategoryId = 3 },
                new Product { Id = 3, Name = "Transformer 3", Picture = "https://i.pinimg.com/736x/3e/87/a1/3e87a13aedb09fcaac9ce75b5ad93d27.jpg", Description = "Description for Transformer 3", StockCount = 10, CategoryId = 2 },
                new Product { Id = 4, Name = "Transformer 4", Picture = "https://i.pinimg.com/originals/9f/bf/05/9fbf05e55cabc5e5ba61e5df243561d5.gif", Description = "Description for Transformer 4", StockCount = 10, CategoryId = 1 }
            );
